...
const heroImages = ['/images/tiles/images/tiles//images/tiles/tiles-wall.jpg','/images/tiles/images/tiles//images/tiles/tiles-decor.jpg','/images/tiles/images/tiles//images/tiles/tiles-floor.jpg']
...
function Logo() {
  return (
    <div className="flex items-center gap-2">
      <img src="//images/images//images/kleihaus-logo.jpg" alt="Kleihaus Ceramics" className="h-8 w-8 rounded-xl object-contain" />
        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-4 max-w-xl text-neutral-600">
              Kleihaus is Africa's leading wholesaler and retailer of building and finishing materials specializing in <strong>Tiles, Sanitaryware, and Paints</strong>. From concept to finish, we help homeowners, builders, and designers pick the right materials—on budget and on time.
            </p>
            ...
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl border shadow-sm">
              {heroImages.map((src, i) => (
                <motion.img
                  ...
                  onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '//images/images//images/placeholder.jpg' }}
                />
              ))}
        ...
        {items.map((it) => (
          <Card key={it.name} className="overflow-hidden">
            <div className="relative aspect-[4/3] w-full">
              <img src={it.img} alt={it.name} onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '//images/images//images/placeholder.jpg' }} className="absolute inset-0 h-full w-full object-cover" />
            </div>
    ...
    <section id="catalogue" className="mx-auto max-w-7xl px-4 py-16">
      ...
      <div className="mt-12 space-y-12">
        <CatalogueSection
          title="Tiles"
          items={[
            { name: 'Floor tiles', img: '/images/tiles/images/tiles//images/tiles/tiles-floor.jpg' },
            { name: 'Wall tiles', img: '/images/tiles/images/tiles//images/tiles/tiles-wall.jpg' },
            { name: 'Decor tiles', img: '/images/tiles/images/tiles//images/tiles/tiles-decor.jpg' },
          ]}
        />
        <CatalogueSection
          title="Adhesives & finishing"
          items={[
            { name: 'Tile adhesives', img: '//images/images//images/adhesive.jpg' },
            { name: 'Tile grout', img: '//images/images//images/grout.jpg' },
            { name: 'Tile fittings (trims, spacers)', img: '/images/tiles/images/tiles//images/tiles/tile-fittings.jpg' },
            { name: 'Tile tools', img: '/images/tiles/images/tiles//images/tiles/tile-tools.jpg' },
          ]}
        />
        <CatalogueSection
          title="Sanitaryware"
          items={[
            { name: 'Baths', img: '/images/sanitaryware/images/sanitaryware//images/sanitaryware/sanitary-baths.jpg' },
            { name: 'Toilets', img: '/images/sanitaryware/images/sanitaryware//images/sanitaryware/sanitary-toilets.jpg' },
            { name: 'Showers', img: '/images/sanitaryware/images/sanitaryware//images/sanitaryware/sanitary-showers.jpg' },
            { name: 'Taps & mixers', img: '/images/sanitaryware/images/sanitaryware//images/sanitaryware/sanitary-taps.jpg' },
            { name: 'Basins', img: '/images/sanitaryware/images/sanitaryware//images/sanitaryware/sanitary-basins.jpg' },
            { name: 'Bathroom accessories', img: '/images/sanitaryware/images/sanitaryware//images/sanitaryware/sanitary-accessories.jpg' },
            { name: 'Kitchens', img: '//images/images//images/kitchen.jpg' },
            { name: 'Sinks', img: '//images/images//images/sinks.jpg' },
            { name: 'Sink accessories', img: '//images/images//images/sink-accessories.jpg' },
          ]}
        />
        <CatalogueSection
          title="Paints"
          items={[
            { name: 'Interior paints', img: '/images/paints/images/paints//images/paints/paint-interior.jpg' },
            { name: 'Exterior paints', img: '/images/paints/images/paints//images/paints/paint-exterior.jpg' },
            { name: 'Roof paints', img: '/images/paints/images/paints//images/paints/paint-roof.jpg' },
            { name: 'Floor paints', img: '/images/tiles/images/tiles//images/tiles/paint-floor.jpg' },
          ]}
        />
        <CatalogueSection
          title="Tile installation services"
          items={[{ name: 'Professional tile laying', img: '/images/tiles/images/tiles//images/tiles/tiler-service.jpg' }]}
        />
      </div>
    </section>
  )
