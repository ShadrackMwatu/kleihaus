...
function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      onClick={(event) => {
        const contextualMessage = event.currentTarget.dataset.message
        if (contextualMessage) event.currentTarget.href = buildWhatsAppUrl(contextualMessage)
        handleClick()
      }}
      id="kleihaus-whatsapp"
