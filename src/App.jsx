        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-4 max-w-xl text-neutral-600">
              Kleihaus is Africa's leading wholesaler and retailer of building and finishing materials specializing in Tiles, Sanitaryware, and paints. From concept to finish, we help homeowners, builders, and designers pick the right materials—on budget and on time.
            </p>
