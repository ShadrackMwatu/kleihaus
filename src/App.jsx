...
const heroImages = [
  ...
  '/images/tiles-gallery-1.jpg',
  '/images/sanitary-set-1.jpg',
  '/images/sink-gold-1.png',
  '/images/sink-mixer-1.png',
  '/images/bathroom-blue-1.jpg',
  '/images/shower-rail-1.jpg',
  '/images/taps-display-1.jpg',
]
    ...
    >
      ...
      */}
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-10 px-6 py-24 sm:py-28 lg:py-32 lg:flex-row lg:items-center">
        ...
        {/* Right spacer for layout on large screens (carousel image removed to avoid duplication) */}
