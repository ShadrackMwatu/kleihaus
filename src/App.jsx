      ...
      <div className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex items-center gap-2 text-neutral-700"><MapPin className="h-4 w-4" /> <span className="block">Nairobi | Machakos | Makueni</span><span className="block">Kenya, Africa</span>
Kenya, Africa</div>
