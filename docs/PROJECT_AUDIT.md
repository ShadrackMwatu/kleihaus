...
- The public route set now includes `/`, `/tiles`, `/floor-tiles`, `/wall-tiles`, `/bathroom-tiles`, `/sanitaryware`, `/paints`, `/adhesives-grout` and `/installation-support`.
...
- Footer product links now provide crawlable internal links to the category guide routes, including the broader `/tiles` page.
